...
const BabyChart = (props) => {
  ...
  const flsd = [
    0.06, 0.15, 0.27, 0.22, 0.23, 0.01, 0.05, 0.08, 0.12, 0.26, 0.38, 0.34,
    0.08, 0.34, 0.36, 0.26, 0.06, 0.04, 0.26, 0.28, 0.26, 0.86, 0.81, 0.69,
  ];
  const acsd = [
    0.11, 0.19, 0.16, 0.21, 0.09, 0.13, 0.12, 0.11, 0.09, 0.13, 0.14, 0.16,
    0.09, 0.11, 0.03, 0.3, 0.03, 0.05, 0.12, 0.19, 0.24, 0.64, 0.57, 0.91,
  ];
  const bpdsd = [
    0.05, 0.06, 0.11, 0.05, 0.17, 0.35, 0.22, 0.22, 0.3, 0.11, 0.15, 0.1, 0.13,
    0.11, 0.15, 0.1, 0.33, 0.14, 0.77, 0.27, 0.06, 0.45, 0.81, 0.99,
  ];
