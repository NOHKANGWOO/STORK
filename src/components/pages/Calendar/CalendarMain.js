  ...
  useEffect(()=>{
    ...
    setWeeks(weeks_date.map((week)=>{
      ...
      return(<div style= {dis}>
              <CalendarWeeks Click_date = {Click_date} date = {week} year = {year} month = {month} data = {data} blood = {blood}/>
             </div>
            );
    }))
  },[month])
  ...
  return (
    ...
    <div className="calendar-main">
      <div className="parent_cale_main">
        <div className="div9_cale_main" onClick={check}  >{month}</div>
        ...
        {/* 요일  */}
        <div className="sat" style = {{fontWeight : 'bolder'}}>SAT</div>
        <div className="fri" style = {{fontWeight : 'bolder'}}>FRI</div>
        <div className="thu"style = {{fontWeight : 'bolder'}}>THU</div>
        <div className="wed" style = {{fontWeight : 'bolder'}}>WED</div>
        <div className="tue" style = {{fontWeight : 'bolder'}}>TUE</div>
        <div className="mon"style = {{fontWeight : 'bolder'}}>MON</div>
        <div className="sun" style = {{fontWeight : 'bolder'}}>SUN</div>

        {/* 년도  */}
        <div className="div45_cale_main">{year}</div>

        {/* memos */}
        <div className="frame-child_cale_main" style={{marginTop:memoStyle}}/>
        <div className="div46_cale_main" style={{marginTop:memoStyle}} >{month}월 {date}일</div>
      ...
      {/* 모달 시간 선택 창  */}
        ...
        <img className="frame-child10_cale_main" alt="" src={ellipse_35} style={{marginTop:memoStyle}} />
        <div className="div49_cale_main" style={{marginTop: memoStyle}} >가임기</div>
        <img className="frame-child11_cale_main" alt="" src={ellipse_36}  style={{marginTop: memoStyle}} />
        <div className="div50_cale_main" style={{marginTop: memoStyle}} >일정</div>
